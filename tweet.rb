...
# a.o.la << [1280, 600, a.t, 0, 2]
# a.la << [ # key state testing
#   "kd: #{a.kd.tk}",
#   "kh: #{a.kh.tk}",
#   "ku: #{a.i.k.ku.tk}",
#   "#text: #{a.it}"
# ].mwi { |s, i| [0, 600 - i * 22, s] }
...
#======== P Class Tests
#==== Various Things
# a.bc=[0,0,0];x=a.mx>W/2? W : 0;y=a.my>H/2? H : 0
# #== Test 1
...
#==== Akziden's Cat
# A||=a.o[S=:b].sp<<[F=79,F,P=140,P,:c,0,D=410,[F]*3];a.sp<<[[320,B=[G=200,20,G,S],97],[440,B,-F],[H=360,P,4*H,720,S],[345,220,896,504,S],[H,300,V=[256,H,S,15]],[D,310,V],[D,G,V],[450,175,V],[570,135,V[0,3],-15],P.t.m{|i|[550,345,atan(Z=a.t.d(5))*i,Z.sin*i,S,a.t.cos*i]}]
#====
...
a.bc=Z*3
I||=(K=(S=128)*S
D=P.dso(:n,:p){n=0;@p.e{|p|n+=p.n};@n=n==12?4:(n==16?@n:0);@r=F*@n}
v=H.d(S)
y=(H-S*v)/2
x=(W-S*v)/2
_SO!M=K.t.m{|i|d=D.new(x+(i%S)*v=(H/S).i,y+v*i.d(S),v,v);d.n=rand>0.6?4:0;d}
K.t.e{|i|M[i].p=9.t.m{|x|M[(i+x/3+x%3*S-S-1).rn%K]}})
#====
